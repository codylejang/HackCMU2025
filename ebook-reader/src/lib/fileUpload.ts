        ...
        return new Promise((resolve, reject) => {
          ...
          epubInstance.on('end', () => {
            ...
            const extractChapterContent = (chapterIndex: number) => {
              ...
              if (chapterTitle.toLowerCase().includes('cover') || 
                  chapterTitle.toLowerCase().includes('contents') ||
                  chapterTitle.toLowerCase().includes('war and peace') ||
                  chapterTitle.toLowerCase().includes('book') && !chapterTitle.toLowerCase().includes('chapter')) {
              ...
              if (readingItem.href) {
                ...
                chapter = flow.find((item: any) => item.href === baseHref);
              }
