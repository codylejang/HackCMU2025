...
"[project]/frontend/src/lib/database.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/frontend/src/lib/fileUpload.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__ = __turbopack_context__.i("[externals]/fs [external] (fs, cjs)");
var __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__ = __turbopack_context__.i("[externals]/path [external] (path, cjs)");
var __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/frontend/src/lib/database.ts [app-route] (ecmascript)");
;
;
;
async function saveUploadedFile(file) {
    try {
        ...
        const uniqueFilename = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["generateUniqueFilename"])(file.name);
        ...
        return {
            success: true,
            bookId: (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["generateBookId"])(),
            filePath,
            coverPath
        };
    } catch (error) {
                ...
                return new Promise((resolve, reject)=>{
                    ...
                    epubInstance.on('end', ()=>{
                        ...
                        const extractChapterContent = (chapterIndex)=>{
                            ...
                            // Skip non-chapter items (like cover page, TOC, etc.)
                            if (chapterTitle.toLowerCase().includes('cover') || chapterTitle.toLowerCase().includes('contents') || chapterTitle.toLowerCase().includes('war and peace') || chapterTitle.toLowerCase().includes('book') && !chapterTitle.toLowerCase().includes('chapter')) {
                                // Process next chapter
                                extractChapterContent(chapterIndex + 1);
                                return;
                            }
                            fullText += `## ${chapterTitle}\n\n`;
                            // Find the corresponding chapter in flow by href (more reliable than ID)
                            let chapter = null;
                            if (readingItem.href) {
                                // Extract the base href without the fragment identifier
                                const baseHref = readingItem.href.split('#')[0];
                                chapter = flow.find((item)=>item.href === baseHref);
                            }
                            // If not found by href, try to find by index
                            if (!chapter && chapterIndex < flow.length) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/frontend/src/lib/database.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$fileUpload$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/frontend/src/lib/fileUpload.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__ = __turbopack_context__.i("[externals]/path [external] (path, cjs)");
;
;
;
...
async function GET() {
    try {
        const books = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAllBooks"])();
...
async function POST(request) {
    try {
        ...
        const uploadResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$fileUpload$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["saveUploadedFile"])(file);
        ...
        let content;
        try {
            content = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$fileUpload$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["extractTextContent"])(uploadResult.filePath, fileType);
        } catch (error) {
        ...
        try {
            const coverGenerated = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$fileUpload$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["generateBookCover"])(title, fileType, uploadResult.coverPath, uploadResult.filePath);
            if (coverGenerated) {
        ...
        // Save to database
        const savedBook = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["addBook"])(newBook);
        return __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
            data: savedBook
        });
...
async function DELETE(request) {
    try {
        ...
        const success = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["deleteBook"])(bookId);
        if (!success) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5fcb3467._.js.map